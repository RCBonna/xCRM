    ...
    <div className="relative flex h-12 w-full min-w-0 items-center gap-2 rounded-md border border-border bg-surface px-3 text-left">
      ...
      {unreadNotificationsCount > 0 ? (
        <span
          ...
          className="absolute -right-2 -top-2 grid min-h-6 min-w-6 place-items-center rounded-full border border-background bg-danger px-1.5 text-xs font-semibold leading-none text-background shadow-sm"
        >
          {badgeLabel}
        </span>
      ) : null}
